...
uint32_t *mc_finish_addr          = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_FINISH_EPA));
uint32_t *mc_time_addr            = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_TIME_EPA));
uint32_t *mc_fail_addr            = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_FAIL_EPA));
uint32_t *mc_stdout_addr          = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_STDOUT_EPA));
uint32_t *mc_stderr_addr          = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_STDERR_EPA));
uint32_t *mc_branch_trace_addr    = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_BRANCH_TRACE_EPA));
uint32_t *mc_print_stat_addr      = (uint32_t *) (mc_tile_mmio | mc_host_y_coord | mc_host_x_coord | (HB_MC_HOST_PRINT_STAT_EPA));
