...
set keepout_margins_wide [list [expr 2*$keepout_margin_x] [expr $keepout_margin_y] [expr 2*$keepout_margin_x] [expr $keepout_margin_y]]
set keepout_margins_narrow [list [expr $keepout_margin_x] [expr 2*$keepout_margin_y] [expr $keepout_margin_x] [expr 2*$keepout_margin_y]]
...
set_macro_relative_location \
  ...
  -offset [list [expr $keepout_margin_x] [expr 0*$keepout_margin_y]]
#-anchor_object $icache_data_ma_west \
#  -offset [list [expr $tile_width/2 - $btb_mem_width/2 - $ireg_mem_width/2 - 3*$freg_mem_width/2] [expr -$tile_height/2 + $btb_mem_height/2]]
