...
append_to_collection all_nets [get_nets -of [get_pins -of $cells -filter "name=~core_reset*"]]
append_to_collection all_nets [get_nets -of [get_pins -of $cells -filter "name=~core_global*"]]
