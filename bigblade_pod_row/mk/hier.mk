...
export ETM_BLOCKS += bsg_manycore_link_to_sdr_north_row,$(BSG_DESIGNS_TARGET_DIR)/../bsg_manycore_link_to_sdr_north_row/bsg_14/current_build
export ETM_BLOCKS += bsg_manycore_link_to_sdr_south_row,$(BSG_DESIGNS_TARGET_DIR)/../bsg_manycore_link_to_sdr_south_row/bsg_14/current_build
