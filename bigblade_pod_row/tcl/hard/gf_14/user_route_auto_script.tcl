...
append_to_collection all_nets [get_nets -of [get_pins -of $sdr_north_cells -filter "name=~pod_tags_i_op_"]]
append_to_collection all_nets [get_nets -of [get_pins -of $sdr_north_cells -filter "name=~pod_tags_i_en_"]]
append_to_collection all_nets [get_nets -of [get_pins -of $sdr_north_cells -filter "name=~pod_tags_i_param_"]]
