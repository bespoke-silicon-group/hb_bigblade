...
disconnect_net [get_net "pod_tags_i[3]"] -all
disconnect_net [get_net "pod_tags_i[7]"] -all
disconnect_net [get_net "pod_tags_i[11]"] -all
disconnect_net [get_net "pod_tags_i[15]"] -all
...
set C11 [bsg_create_clock_buffer $C9 4807 933]
...
set LVN7 [bsg_create_clock_buffer $LVN5 2429 1693]
#set LVN8 [bsg_create_clock_buffer $LVN7 2429 1771]
set LVN9 [bsg_create_clock_buffer $LVN7 2429 1844 0]


set LCL0 [bsg_create_clock_buffer $LH7  2267  933 1 8]
set LCL1 [bsg_create_clock_buffer $LCL0 1971  933 1 8]
set LCL2 [bsg_create_clock_buffer $LCL1 1673  933 1 8]
set LCL3 [bsg_create_clock_buffer $LCL2 1369  933 1 16]
bsg_connect_sinks $LCL3 [get_pins "podrow/px_0__pod/mc_y_2__mc_x_0__mc/clk_i"]
set LCR0 [bsg_create_clock_buffer $LH7  2572  933 1 8]
set LCR1 [bsg_create_clock_buffer $LCR0 2873  933 1 8]
set LCR2 [bsg_create_clock_buffer $LCR1 3164  933 1 8]
set LCR3 [bsg_create_clock_buffer $LCR2 3465  933 1 16]
bsg_connect_sinks $LCR3 [get_pins "podrow/px_1__pod/mc_y_2__mc_x_0__mc/clk_i"]

set LN1L0 [bsg_create_clock_buffer $LVN3  2267  1312 1 8]
set LN1L1 [bsg_create_clock_buffer $LN1L0 1971  1312 1 8]
set LN1L2 [bsg_create_clock_buffer $LN1L1 1673  1312 1 8]
set LN1L3 [bsg_create_clock_buffer $LN1L2 1369  1312 1 16]
bsg_connect_sinks $LN1L3 [get_pins "podrow/px_0__pod/mc_y_1__mc_x_0__mc/clk_i"]
set LN1R0 [bsg_create_clock_buffer $LVN3  2572  1312 1 8]
set LN1R1 [bsg_create_clock_buffer $LN1R0 2873  1312 1 8]
set LN1R2 [bsg_create_clock_buffer $LN1R1 3164  1312 1 8]
set LN1R3 [bsg_create_clock_buffer $LN1R2 3465  1312 1 16]
...
set LS1L0 [bsg_create_clock_buffer $LVS3  2267  552 1 8]
set LS1L1 [bsg_create_clock_buffer $LS1L0 1971  552 1 8]
set LS1L2 [bsg_create_clock_buffer $LS1L1 1673  552 1 8]
set LS1L3 [bsg_create_clock_buffer $LS1L2 1369  552 1 16]
bsg_connect_sinks $LS1L3 [get_pins "podrow/px_0__pod/mc_y_3__mc_x_0__mc/clk_i"]
set LS1R0 [bsg_create_clock_buffer $LVS3  2572  552 1 8]
set LS1R1 [bsg_create_clock_buffer $LS1R0 2873  552 1 8]
set LS1R2 [bsg_create_clock_buffer $LS1R1 3164  552 1 8]
set LS1R3 [bsg_create_clock_buffer $LS1R2 3465  552 1 16]
bsg_connect_sinks $LS1R3 [get_pins "podrow/px_1__pod/mc_y_3__mc_x_0__mc/clk_i"]

set LS2L0 [bsg_create_clock_buffer $LVS7  2267  172 1 8] 
set LS2L1 [bsg_create_clock_buffer $LS2L0 1971  172 1 8]
set LS2L2 [bsg_create_clock_buffer $LS2L1 1673  172 1 8]
set LS2L3 [bsg_create_clock_buffer $LS2L2 1369  172 1 16]
bsg_connect_sinks $LS2L3 [get_pins "podrow/px_0__pod/south_vc_x_0__south_vc_row/clk_i"]
set LS2R0 [bsg_create_clock_buffer $LVS7  2572  172 1 8]
set LS2R1 [bsg_create_clock_buffer $LS2R0 2873  172 1 8]
set LS2R2 [bsg_create_clock_buffer $LS2R1 3164  172 1 8]
set LS2R3 [bsg_create_clock_buffer $LS2R2 3465  172 1 16]
...
set RVN7 [bsg_create_clock_buffer $RVN5 7186 1693]
#set RVN8 [bsg_create_clock_buffer $RVN7 7186 1771]
set RVN9 [bsg_create_clock_buffer $RVN7 7186 1844 0]


set RCL0 [bsg_create_clock_buffer $RH7  7028  933 1 8]
set RCL1 [bsg_create_clock_buffer $RCL0 6732  933 1 8]
set RCL2 [bsg_create_clock_buffer $RCL1 6433  933 1 8]
set RCL3 [bsg_create_clock_buffer $RCL2 6134  933 1 16]
bsg_connect_sinks $RCL3 [get_pins "podrow/px_2__pod/mc_y_2__mc_x_0__mc/clk_i"]
set RCR0 [bsg_create_clock_buffer $RH7  7335  933 1 8]
set RCR1 [bsg_create_clock_buffer $RCR0 7629  933 1 8]
set RCR2 [bsg_create_clock_buffer $RCR1 7925  933 1 8]
set RCR3 [bsg_create_clock_buffer $RCR2 8220  933 1 16]
bsg_connect_sinks $RCR3 [get_pins "podrow/px_3__pod/mc_y_2__mc_x_0__mc/clk_i"]

set RN1L0 [bsg_create_clock_buffer $RVN3   7028  1312 1 8]
set RN1L1 [bsg_create_clock_buffer $RN1L0  6732  1312 1 8]
set RN1L2 [bsg_create_clock_buffer $RN1L1  6433  1312 1 8]
set RN1L3 [bsg_create_clock_buffer $RN1L2  6134  1312 1 16]
bsg_connect_sinks $RN1L3 [get_pins "podrow/px_2__pod/mc_y_1__mc_x_0__mc/clk_i"]
set RN1R0 [bsg_create_clock_buffer $RVN3   7335  1312 1 8]
set RN1R1 [bsg_create_clock_buffer $RN1R0  7629  1312 1 8]
set RN1R2 [bsg_create_clock_buffer $RN1R1  7925  1312 1 8]
set RN1R3 [bsg_create_clock_buffer $RN1R2  8220  1312 1 16]
...
set RS1L0 [bsg_create_clock_buffer $RVS3   7028  552 1 8]
set RS1L1 [bsg_create_clock_buffer $RS1L0  6732  552 1 8]
set RS1L2 [bsg_create_clock_buffer $RS1L1  6433  552 1 8]
set RS1L3 [bsg_create_clock_buffer $RS1L2  6134  552 1 16]
bsg_connect_sinks $RS1L3 [get_pins "podrow/px_2__pod/mc_y_3__mc_x_0__mc/clk_i"]
set RS1R0 [bsg_create_clock_buffer $RVS3   7335  552 1 8]
set RS1R1 [bsg_create_clock_buffer $RS1R0  7629  552 1 8]
set RS1R2 [bsg_create_clock_buffer $RS1R1  7925  552 1 8]
set RS1R3 [bsg_create_clock_buffer $RS1R2  8220  552 1 16]
bsg_connect_sinks $RS1R3 [get_pins "podrow/px_3__pod/mc_y_3__mc_x_0__mc/clk_i"]

set RS2L0 [bsg_create_clock_buffer $RVS7   7028  172 1 8]
set RS2L1 [bsg_create_clock_buffer $RS2L0  6732  172 1 8]
set RS2L2 [bsg_create_clock_buffer $RS2L1  6433  172 1 8]
set RS2L3 [bsg_create_clock_buffer $RS2L2  6134  172 1 16]
bsg_connect_sinks $RS2L3 [get_pins "podrow/px_2__pod/south_vc_x_0__south_vc_row/clk_i"]
set RS2R0 [bsg_create_clock_buffer $RVS7   7335  172 1 8]
set RS2R1 [bsg_create_clock_buffer $RS2R0  7629  172 1 8]
set RS2R2 [bsg_create_clock_buffer $RS2R1  7925  172 1 8]
set RS2R3 [bsg_create_clock_buffer $RS2R2  8220  172 1 16]
