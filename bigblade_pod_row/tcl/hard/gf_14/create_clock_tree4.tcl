...
set LH8   [bsg_create_clock_buffer $LH7P5  2115 932  1 4]
set LH9   [bsg_create_clock_buffer $LH8  1825 932  1 4]
set LH10  [bsg_create_clock_buffer $LH9  1528 932  1 4]
set LH11  [bsg_create_clock_buffer $LH10 1229 932  1 4]
set LH12  [bsg_create_clock_buffer $LH11 933  932  1 8]
set LH13  [bsg_create_clock_buffer $LH12 638  932  1 8]
set LH14  [bsg_create_clock_buffer $LH13 353  932  1 8]
set LH15  [bsg_create_clock_buffer $LH14 51   932  1 8]
...
set RH8   [bsg_create_clock_buffer $RH7P5 7477 932  1 4]
set RH9   [bsg_create_clock_buffer $RH8   7777 932  1 4]
set RH10  [bsg_create_clock_buffer $RH9   8069 932  1 4]
set RH11  [bsg_create_clock_buffer $RH10  8367 932  1 4]
set RH12  [bsg_create_clock_buffer $RH11  8663 932  1 8]
set RH13  [bsg_create_clock_buffer $RH12  8954 932  1 8]
set RH14  [bsg_create_clock_buffer $RH13  9254 932  1 8]
set RH15  [bsg_create_clock_buffer $RH14  9565 932  1 8]
...
set LVN4_L2_SDR [bsg_create_clock_buffer $LVN4_L2     1528 1842.5 0 6 "L"]
set LVN4_L3_SDR [bsg_create_clock_buffer $LVN4_L2_SDR 1380 1842.5 1 6 "L"]
set LVN4_L3_VC [bsg_create_clock_buffer  $LVN4_L2     1384 1842.5]
...
set LVN4_R2_SDR [bsg_create_clock_buffer $LVN4_R2     3313 1842.5 0 6 "L"]
set LVN4_R3_SDR [bsg_create_clock_buffer $LVN4_R2_SDR 3465 1842.5 1 6 "L"]
set LVN4_R3_VC  [bsg_create_clock_buffer  $LVN4_R2    3469 1842.5]
...
set RVN4_L2_SDR [bsg_create_clock_buffer $RVN4_L2     6286 1842.5 0 6 "L"]
set RVN4_L3_SDR [bsg_create_clock_buffer $RVN4_L2_SDR 6138 1842.5 1 6 "L"]
set RVN4_L3_VC [bsg_create_clock_buffer  $RVN4_L2     6141 1842.5]
...
set RVN4_R2_SDR [bsg_create_clock_buffer $RVN4_R2     8072 1842.5 0 6 "L"]
set RVN4_R3_SDR [bsg_create_clock_buffer $RVN4_R2_SDR 8223 1842.5 1 6 "L"]
set RVN4_R3_VC [bsg_create_clock_buffer  $RVN4_R2     8226 1842.5]
...
set LVN1_X0 [bsg_create_clock_buffer $LVN1_XM1 2115 1312 1 4]
set LVN1_X1 [bsg_create_clock_buffer $LVN1_X0 1825 1312 1 4]
set LVN1_X2 [bsg_create_clock_buffer $LVN1_X1 1527 1312 1 4]
set LVN1_X3 [bsg_create_clock_buffer $LVN1_X2 1229 1312 1 4]
set LVN1_X4 [bsg_create_clock_buffer $LVN1_X3 933  1312 1 8]
set LVN1_X5 [bsg_create_clock_buffer $LVN1_X4 638  1312 1 8]
set LVN1_X6 [bsg_create_clock_buffer $LVN1_X5 353  1312 1 8]
set LVN1_X7 [bsg_create_clock_buffer $LVN1_X6 51   1312 1 8]
...
set LVS1_X0 [bsg_create_clock_buffer $LVS1    2115 551 1 4]
set LVS1_X1 [bsg_create_clock_buffer $LVS1_X0 1825 551 1 4]
set LVS1_X2 [bsg_create_clock_buffer $LVS1_X1 1527 551 1 4]
set LVS1_X3 [bsg_create_clock_buffer $LVS1_X2 1229 551 1 4]
set LVS1_X4 [bsg_create_clock_buffer $LVS1_X3 933  551 1 8]
set LVS1_X5 [bsg_create_clock_buffer $LVS1_X4 638  551 1 8]
set LVS1_X6 [bsg_create_clock_buffer $LVS1_X5 353  551 1 8]
set LVS1_X7 [bsg_create_clock_buffer $LVS1_X6 51   551 1 8]
...
set LVS3_X0 [bsg_create_clock_buffer $LVS3    2115 172 1 4]
set LVS3_X1 [bsg_create_clock_buffer $LVS3_X0 1825 172 1 4]
set LVS3_X2 [bsg_create_clock_buffer $LVS3_X1 1527 172 1 4]
set LVS3_X3 [bsg_create_clock_buffer $LVS3_X2 1229 172 1 4]
set LVS3_X4 [bsg_create_clock_buffer $LVS3_X3 933  172 1 8]
set LVS3_X5 [bsg_create_clock_buffer $LVS3_X4 638  172 1 8]
set LVS3_X6 [bsg_create_clock_buffer $LVS3_X5 353  172 1 8]
set LVS3_X7 [bsg_create_clock_buffer $LVS3_X6 51   172 1 8]
bsg_connect_sink $LVS3_X7 [get_pins {sdr_sw/core_clk_i}]


set RVN1_XM1 [bsg_create_clock_buffer $RVN1     7194 1312 0 4]
set RVN1_X0  [bsg_create_clock_buffer $RVN1_XM1 7477 1312 1 4]
set RVN1_X1 [bsg_create_clock_buffer $RVN1_X0  7777 1312 1 4]
set RVN1_X2 [bsg_create_clock_buffer $RVN1_X1  8069 1312 1 4]
set RVN1_X3 [bsg_create_clock_buffer $RVN1_X2  8367 1312 1 4]
set RVN1_X4 [bsg_create_clock_buffer $RVN1_X3  8663 1312 1 8]
set RVN1_X5 [bsg_create_clock_buffer $RVN1_X4  8954 1312 1 8]
set RVN1_X6 [bsg_create_clock_buffer $RVN1_X5  9254 1312 1 8]
set RVN1_X7 [bsg_create_clock_buffer $RVN1_X6  9565 1312 1 8]
...
set RVS1_X0 [bsg_create_clock_buffer $RVS1     7477 551 1 4]
set RVS1_X1 [bsg_create_clock_buffer $RVS1_X0  7777 551 1 4]
set RVS1_X2 [bsg_create_clock_buffer $RVS1_X1  8069 551 1 4]
set RVS1_X3 [bsg_create_clock_buffer $RVS1_X2  8367 551 1 4]
set RVS1_X4 [bsg_create_clock_buffer $RVS1_X3  8663 551 1 8]
set RVS1_X5 [bsg_create_clock_buffer $RVS1_X4  8954 551 1 8]
set RVS1_X6 [bsg_create_clock_buffer $RVS1_X5  9254 551 1 8]
set RVS1_X7 [bsg_create_clock_buffer $RVS1_X6  9565 551 1 8]
...
set RVS3_X0 [bsg_create_clock_buffer $RVS3     7477 172 1 4]
set RVS3_X1 [bsg_create_clock_buffer $RVS3_X0  7777 172 1 4]
set RVS3_X2 [bsg_create_clock_buffer $RVS3_X1  8069 172 1 4]
set RVS3_X3 [bsg_create_clock_buffer $RVS3_X2  8367 172 1 4]
set RVS3_X4 [bsg_create_clock_buffer $RVS3_X3  8663 172 1 8]
set RVS3_X5 [bsg_create_clock_buffer $RVS3_X4  8954 172 1 8]
set RVS3_X6 [bsg_create_clock_buffer $RVS3_X5  9254 172 1 8]
set RVS3_X7 [bsg_create_clock_buffer $RVS3_X6  9565 172 1 8]
