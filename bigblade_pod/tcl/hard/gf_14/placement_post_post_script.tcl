...
for {set y 0} {$y < $HB_NUM_TILES_Y_P} {incr y} {
  for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
    set tile_cell [get_cell "pod/mc/y_${y}__x_${x}__tile"]
...
for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
  set tile_cell [get_cell "pod/north_vc_row/vc_x_${x}__vc"]
  set tile_lly [get_attribute $tile_cell boundary_bounding_box.ll_y]
  set tile_urx [get_attribute $tile_cell boundary_bounding_box.ur_x]
  set tile_ury [get_attribute $tile_cell boundary_bounding_box.ur_y]
...
for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
  set tile_cell [get_cell "pod/south_vc_row/vc_x_${x}__vc"]
  set tile_lly [get_attribute $tile_cell boundary_bounding_box.ll_y]
  set tile_urx [get_attribute $tile_cell boundary_bounding_box.ur_x]
  set tile_ury [get_attribute $tile_cell boundary_bounding_box.ur_y]
...
for {set y 0} {$y < $HB_NUM_TILES_Y_P} {incr y} {
  for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
    set lly [get_attribute [get_cells "pod/mc/y_${y}__x_${x}__tile"] boundary_bounding_box.ll_y]
    set ury [get_attribute [get_cells "pod/mc/y_${y}__x_${x}__tile"] boundary_bounding_box.ur_y]
    
    # left side of buffer
    set llx [get_attribute [get_cells "pod/mc/y_${y}__x_${x}__tile"] boundary_bounding_box.ur_x]
    ...
    set xp1 [expr $x+1]
    set urx [get_attribute [get_cells "pod/mc/y_${y}__x_${xp1}__tile"] boundary_bounding_box.ll_x]
...
for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
  set lly [get_attribute [get_cells "pod/north_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ll_y]
  set ury [get_attribute [get_cells "pod/north_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ur_y]

  # left side
  set llx [get_attribute [get_cells "pod/north_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ur_x]
  set urx [expr $llx + $RB_RP_X_OFFSET]
  set boundary [list [list $llx $lly] [list $urx $ury]]
  create_placement_blockage -boundary $boundary -type hard -name "north_vc_rp_${x}_${y}_left"
  # right side
  set xp1 [expr $x+1]
  set urx [get_attribute [get_cells "pod/north_vc_row/vc_x_${xp1}__vc"] boundary_bounding_box.ll_x]
...
for {set x 0} {$x < [expr $HB_NUM_TILES_X_P-1]} {incr x} {
  set lly [get_attribute [get_cells "pod/south_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ll_y]
  set ury [get_attribute [get_cells "pod/south_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ur_y]

  # left side
  set llx [get_attribute [get_cells "pod/south_vc_row/vc_x_${x}__vc"] boundary_bounding_box.ur_x]
  set urx [expr $llx + $RB_RP_X_OFFSET]
  set boundary [list [list $llx $lly] [list $urx $ury]]
  create_placement_blockage -boundary $boundary -type hard -name "south_vc_rp_${x}_${y}_left"
  # right side
  set xp1 [expr $x+1]
  set urx [get_attribute [get_cells "pod/south_vc_row/vc_x_${xp1}__vc"] boundary_bounding_box.ll_x]
  set llx [expr $urx - (0.084*46)]
  set boundary [list [list $llx $lly] [list $urx $ury]]
