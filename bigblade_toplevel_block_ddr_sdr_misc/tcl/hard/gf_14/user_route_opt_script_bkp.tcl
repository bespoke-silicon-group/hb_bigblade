...
set_app_options -name route_opt.flow.enable_ccd_clock_drc_fixing          -value always_off
...
set_app_options -name route_opt.flow.size_only_mode                       -value ""
set_app_options -name route_opt.flow.xtalk_reduction                      -value false
set_app_options -name ccd.targeted_ccd_path_groups -value {REGIN}
#set_app_options -name ccd.targeted_ccd_select_optimization_moves -value size_only
#set_app_options -name ccd.targeted_ccd_wns_optimization_effort -value medium
