...
derive_pin_access_routing_guides -cells [get_cells "core_complex_core_*__bp_*__halfpod"] -layers {K1 K3} -x_width [expr 0.084*4] -y_width 0.001
derive_pin_access_routing_guides -cells [get_cells "core_complex_core_*__bp_*__clk_gen"] -layers {C4} -x_width [expr 0.084*4] -y_width 0.001

derive_pin_access_routing_guides -cells [get_cells "core_complex_core_*__cgra_*__halfpod"] -layers {K1 K3} -x_width [expr 0.084*4] -y_width 0.001
derive_pin_access_routing_guides -cells [get_cells "core_complex_core_*__cgra_*__clk_gen"] -layers {C4} -x_width [expr 0.084*4] -y_width 0.001
...
# block dimensions
set clk_gen_width  26.88
set clk_gen_height 10.56

set bp_actual_width   282.24
set cgra_actual_width [round_up_to_nearest 425.00 [unit_width]]

set bp_width   [expr [round_up_to_nearest $bp_actual_width $grid_width]+$grid_width]
set cgra_width [round_up_to_nearest $cgra_actual_width $grid_width]
...
set llx [expr $pod_row_start_x+$pod_width/2+12]
set urx [expr $pod_row_start_x+$pod_width/2+32]
create_routing_blockage -name rb_clk_gen -layers [get_layers {M2 C4 K1 K3 H1 G1}] -boundary "{{$llx $lly} {$urx $ury}}"
...
for {set i 0} {$i < 4} {incr i} {
  ...
  set ury [expr $lly+3*$tile_height+2*0.5*$grid_height]
  set lly2 [expr $lly+4*($tile_height+0.5*$grid_height)]
  set ury2 [expr $ury+4*($tile_height+0.5*$grid_height)]
  # gap routing blockages
  create_routing_blockage -name rb_bp_gap -layers [get_layers {M3 C5 K2 K4 H2 G2}] -boundary "{{[expr $bp_start_x+$bp_actual_width] $lly} {$pod_row_start_x $ury}}"
  create_routing_blockage -name rb_bp_gap -layers [get_layers {M3 C5 K2 K4 H2 G2}] -boundary "{{[expr $bp_start_x+$bp_actual_width] $lly2} {$pod_row_start_x $ury2}}"
}
...
for {set i 0} {$i < 4} {incr i} {
  set lly [expr $pod_row_start_y+$i*($pod_height+$pod_gap)+$sdr_vert_height+$vcache_array_height+0.25*$grid_height+0.5*$grid_height]
  set ury [expr $lly+8*$tile_height+7*0.5*$grid_height]
  # gap routing blockages
  create_routing_blockage -name rb_cgra_gap -layers [get_layers {M3 C5 K2 K4 H2 G2}] -boundary "{{[expr $pod_row_start_x+$pod_width] $lly} {$cgra_start_x $ury}}"
}
...
append_to_collection tag_nets [get_nets -of_object [get_pins "core_complex_core_*__cgra_*__halfpod/clk_i"]]
append_to_collection tag_nets [get_nets -of_object [get_pins "core_complex_core_*__cgra_*__halfpod/tag_node_id_offset_i*"]]
...
set length_(DL0_i) 3202.820
set length_(DL0_o) 3126.148
set length_(DL1_i) 1628.957
set length_(DL1_o) 1720.476
set length_(DL2_i) 2694.397
set length_(DL2_o) 2602.877
set length_(DL3_i) 1071.437
set length_(DL3_o)  978.893
set length_(DL4_i) 1233.357
set length_(DL4_o) 1141.197
set length_(DL5_i) 2298.733
set length_(DL5_o) 2391.276
set length_(DL6_i) 1932.476
set length_(DL6_o) 1829.693
set length_(DL7_i) 3544.125
set length_(DL7_o) 3442.109

set length_(DR0_i) 2986.899
set length_(DR0_o) 3079.956
set length_(DR1_i) 1645.709
set length_(DR1_o) 1717.773
set length_(DR2_i) 2680.253
set length_(DR2_o) 2608.189
set length_(DR3_i) 1056.829
set length_(DR3_o)  985.661
set length_(DR4_i) 1219.645
set length_(DR4_o) 1147.069
set length_(DR5_i) 2315.789
set length_(DR5_o) 2387.084
...
set ss_mc_nets [get_nets -of_object [get_pins "io_link/mc_*_link_*"]]
add_buffer_on_route -net_prefix bsg_ss -cell_prefix bsg_ss -repeater_distance 100.00 $ss_WH_nets $ss_buffer
add_buffer_on_route -net_prefix bsg_ss -cell_prefix bsg_ss -repeater_distance 100.00 $ss_mc_nets $ss_buffer
...
foreach {side} {"DL" "DR" "IT"} {
  ...
  for {set i 0} {$i < $limit} {incr i} {
    foreach {dir} {"i" "o"} {
      ...
      add_buffer_on_route -net_prefix bsg_ss -cell_prefix bsg_ss -repeater_distance_length_ratio $ratio $ss_link_nets $ss_buffer
    }
  }
}
...
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_ML0_4_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_MR0_0_i_int"]]

append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_0_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_1_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_2_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_3_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_4_i_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_5_i_int"]]

append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_0_o_int"]]
append_to_collection msc_nets [get_nets -of_object [get_ports "pad_CB0_1_o_int"]]
