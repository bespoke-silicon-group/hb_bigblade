...
for {set i 0} {$i < 8} {incr i} {
  for {set j 0} {$j < 2} {incr j} {
    ...
    create_clock -period $io_clk_period_ps -name $io_clk_name [get_pins "block/mem_link*${i}*link/ddr_link*${j}*link/clk_gen_io/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
...
for {set j 0} {$j < 2} {incr j} {
  ...
  create_clock -period $io_clk_period_ps -name $io_clk_name [get_pins "block/io_link/ddr_link*${j}*link/clk_gen_io/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
  set_clock_uncertainty $io_clk_uncertainty_ps  [get_clocks $io_clk_name]
  set_propagated_clock [get_clocks $io_clk_name]
...
for {set i 0} {$i < 4} {incr i} {
  ...
  create_clock -period $pod_clk_period_ps -name $wh_master_clk_name [get_pins "block/core_complex_core_${i}__clk_gen/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
...
for {set i 0} {$i < 8} {incr i} {
  ...
  create_clock -period 1000 -name $wh_master_clk_name [get_pins "block/mem_link*${i}*link/ddr_link*0*link/clk_gen_noc/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
...
create_clock -period 1000 -name $wh_master_clk_name [get_pins "block/io_link/ddr_link*0*link/clk_gen_noc/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
set_clock_uncertainty 20 [get_clocks $wh_master_clk_name]
set_propagated_clock [get_clocks $wh_master_clk_name]
foreach {j} {"fwd" "rev"} {
  create_generated_clock \
...
for {set i 0} {$i < 4} {incr i} {
  for {set j 0} {$j < 2} {incr j} {
    ...
    create_clock -period $bp_clk_period_ps -name $wh_master_clk_name [get_pins "block/core_complex_core_${i}__bp_${j}__clk_gen/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
...
for {set i 0} {$i < 4} {incr i} {
  for {set j 0} {$j < 2} {incr j} {
    ...
    create_clock -period $cgra_clk_period_ps -name $wh_master_clk_name [get_pins "block/core_complex_core_${i}__cgra_${j}__clk_gen/clk_gen_inst/mux_inst/*BSG_DONT_TOUCH/Z"]
