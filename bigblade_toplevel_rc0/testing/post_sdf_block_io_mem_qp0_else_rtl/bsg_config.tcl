...
bsg_create_filelist $::env(BIGBLADE_TOPLEVEL_BLOCK_FILELIST) \
    $BIGBLADE_TOPLEVEL_BLOCK_RC0_SOURCE_FILES
...
bsg_create_filelist $::env(BIGBLADE_TOPLEVEL_FILELIST) \
    $BIGBLADE_TOPLEVEL_RC0_SOURCE_FILES
...
bsg_create_filelist $::env(BRG_CGRA_HPOD_FILELIST) \
    $BIGBLADE_BRG_CGRA_EXCEL_SOURCE_FILES

# cgra library
bsg_create_library $::env(BRG_CGRA_HPOD_LIBRARY_NAME)\
    $::env(BRG_CGRA_HPOD_LIBRARY) \
    $BIGBLADE_BRG_CGRA_EXCEL_FILES \
    $BIGBLADE_BRG_CGRA_EXCEL_PATHS
