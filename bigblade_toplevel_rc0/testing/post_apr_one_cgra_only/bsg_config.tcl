...
# cgra source files
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_one_cgra_only/tcl/brg_cgra_hpod_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_one_cgra_only/tcl/brg_cgra_hpod_include.tcl
