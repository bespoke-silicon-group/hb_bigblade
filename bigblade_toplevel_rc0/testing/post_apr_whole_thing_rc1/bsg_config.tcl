...
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_whole_thing_rc1/chip_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_whole_thing_rc1/chip_include.tcl

# testing source (rtl) files and include paths list
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_whole_thing_rc1/gateway_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_whole_thing_rc1/gateway_include.tcl
