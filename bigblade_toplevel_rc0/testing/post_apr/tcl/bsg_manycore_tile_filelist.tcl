...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_tile_compute_ruche-post-apr_filelist.tcl
set BSG_MANYCORE_TILE_SOURCE_FILES [concat $BSG_MANYCORE_TILE_SOURCE_FILES $BIGBLADE_MANYCORE_TILE_SOURCE_FILES]

source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_tile_vcache_array-post-apr_filelist.tcl
set BSG_MANYCORE_TILE_SOURCE_FILES [concat $BSG_MANYCORE_TILE_SOURCE_FILES $BIGBLADE_VCACHE_ARRAY_16X1_SOURCE_FILES]

source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_tile_vcache-post-apr_filelist.tcl
