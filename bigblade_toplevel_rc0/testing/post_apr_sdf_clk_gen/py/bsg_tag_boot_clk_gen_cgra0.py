  ...
  for row in range(4):
    for pos in range(2):
      if (row == 0 and pos == 0):
        ...
        tg.send(masters=0b10, client_id=0+offset, data_not_reset=1, length=1, data=0b1)
        ...
        tg.send(masters=0b10, client_id=1+offset, data_not_reset=1, length=5, data=0b00000)
        
        # take oscillator and trigger flops out of reset
        tg.send(masters=0b10, client_id=0+offset, data_not_reset=1, length=1, data=0b0)
        ...
        tg.send(masters=0b10, client_id=3+offset, data_not_reset=1, length=7, data=0b0000001)
        tg.send(masters=0b10, client_id=3+offset, data_not_reset=1, length=7, data=0b0111110)
        
        # select ds output clk
        #tg.send(masters=0b10, client_id=4+offset, data_not_reset=1, length=2, data=0b01)
        
        # de-assert monitor ds reset
        tg.send(masters=0b10, client_id=5+offset, data_not_reset=1, length=1, data=0b0)
        
        # set ds value
        tg.send(masters=0b10, client_id=3+offset, data_not_reset=1, length=7, data=0b0000010)
        
        for tap in range(32):
          tg.send(masters=0b10, client_id=1+offset, data_not_reset=1, length=5, data=tap)
          tg.send(masters=0b10, client_id=2+offset, data_not_reset=1, length=1, data=0b1)
          tg.send(masters=0b10, client_id=2+offset, data_not_reset=1, length=1, data=0b0)

        # set ds value
        tg.send(masters=0b10, client_id=3+offset, data_not_reset=1, length=7, data=0b0000000)
