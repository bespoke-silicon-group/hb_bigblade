...
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_sdf/chip_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_sdf/chip_include.tcl

# testing source (rtl) files and include paths list
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_sdf/gateway_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_apr_sdf/gateway_include.tcl
