...
# BlackParrot
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_bp_unicore_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_bp_unicore_include.tcl

# cgra
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/brg_cgra_hpod_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/brg_cgra_hpod_include.tcl

# bigblade_toplevel_block
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_toplevel_block_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_toplevel_block_include.tcl
