...
set bsg_designs_target_dir "$bsg_out_dir/bigblade_toplevel_block/$bsg_designs_target"
set basejump_stl_dir       "$bsg_designs_target_dir/basejump_stl"

source $::env(HB_BIGBLADE_NETLISTS_DIR)/bigblade_toplevel_block_post-synth_filelist.tcl
