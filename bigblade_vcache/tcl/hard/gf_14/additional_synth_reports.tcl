...
for {set i 0} {$i < $HB_WH_LINK_WIDTH_P} {incr i} {
  ...
  redirect -append -file ${REPORTS_DIR}/west_input.max.interface_timing.rpt {report_timing -to [get_ports "wh_link_sif_i[$idx]"] -nosplit}
  ...
  redirect -append -file ${REPORTS_DIR}/east_input.max.interface_timing.rpt {report_timing -to [get_ports "wh_link_sif_i[$idx]"] -nosplit}
