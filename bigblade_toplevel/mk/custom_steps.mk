...
generate_black_box:
	...
	cd $(BSG_DESIGNS_TARGET_DIR)/../bigblade_toplevel_block/bsg_14/current_build/pnr/bsg_chip_block && \
	...
	mv /tmp/temp_$(DESIGN_NAME).lef $(BUILD_DIR)/black_box/$(DESIGN_NAME)/$(DESIGN_NAME).lef
