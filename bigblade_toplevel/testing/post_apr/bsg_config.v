config bsg_config;
  ...
  cell bsg_manycore_tile_compute_array_ruche `BSG_MANYCORE_TILE_LIBRARY_NAME `BSG_CHIP_LIBRARY_NAME;
  cell bsg_manycore_tile_vcache_arrary `BSG_MANYCORE_TILE_LIBRARY_NAME `BSG_CHIP_LIBRARY_NAME;
