...
# Old Way:
# source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_sdr-post-apr_filelist.tcl

# New Way: For now, include each of the sub-modules.
set BSG_MANYCORE_LINK_SDR_SOURCE_FILES []
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_ruche_to_sdr_east-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_ruche_to_sdr_west-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_to_sdr_north-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_to_sdr_north_row-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_to_sdr_south-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_to_sdr_south_row-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_wh_to_sdr_ne-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_wh_to_sdr_nw-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_wh_to_sdr_se-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_link_wh_to_sdr_sw-post-apr_filelist.tcl
...
source $::env(HB_BIGBLADE_NETLISTS_DIR)/bsg_manycore_pod_row_sdr-post-apr_filelist.tcl
