...
set basejump_stl_dir "$bsg_out_dir/bsg_tiehilo/$bsg_designs_target/basejump_stl"
set common_dir       "$bsg_out_dir/bsg_tiehilo_mem_link/$bsg_designs_target/../common"

set BSG_TIEHILO_SOURCE_FILES [join "
