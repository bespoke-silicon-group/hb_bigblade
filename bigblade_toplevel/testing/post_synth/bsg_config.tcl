...
# bigblade_toplevel
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_toplevel_filelist.tcl
source $::env(BSG_DESIGNS_TARGET_DIR)/testing/post_synth/tcl/bigblade_toplevel_include.tcl
