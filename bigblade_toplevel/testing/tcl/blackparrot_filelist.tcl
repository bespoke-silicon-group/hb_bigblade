...
set BP_SVERILOG_SOURCE_FILES [join "
  ...
  $bigblade_bp_unicore_dir/v/bp_cce_to_mc_bridge.sv
  $bigblade_bp_unicore_dir/v/bp_cce_splitter.sv
  $bigblade_bp_unicore_dir/v/bp_cce_serializer.sv
  ...
  $bigblade_bp_unicore_dir/v/blackparrot_chip_pkg.v
  $bsg_designs_target_dir/../common/v/bsg_chip_pkg.v
  $bigblade_bp_unicore_dir/v/bsg_blackparrot_unicore_tile_sdr.sv
  $bigblade_bp_unicore_dir/v/bsg_blackparrot_halfpod.sv
"]
