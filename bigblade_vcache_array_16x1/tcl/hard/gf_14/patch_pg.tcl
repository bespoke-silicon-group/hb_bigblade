...
for {set i 0} {$i < 15} {incr i} {
  set strap_loc [expr $c5_starting_x + ($i * $c5_pitch_x)]
  create_pg_strap -tag bsg_pg_patch -direction vertical -net VDD -layer C5 -width 0.700 -low_end -0.080 -start $strap_loc -via_rule {
    {
      {existing: std_conn}
