...
set  sdr_horiz_width      [expr $grid_width*3.5]
...
set  pod_row_width    [expr ($tile_array_width*$HB_NUM_PODS_X_P) + ($grid_width*$HB_NUM_PODS_X_P) + (2*$sdr_horiz_width) + (0.5*$grid_width)]
