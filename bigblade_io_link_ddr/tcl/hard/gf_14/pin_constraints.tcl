...
place_pins_k1_k3 $core_downstream_ports [expr $core_lly+(0.128*300)] $core_urx
...
place_pins_k1_k3 $sdr_out_ports [expr $core_lly+(0.128*50)] $core_llx
place_pins_k1_k3 $sdr_in_ports [expr $core_lly+(0.128*100)] $core_llx
