...
set iddr_bound [create_bound -name "iddr" -type soft -boundary {{0.00 10.50} {16.80 17.80}}]
set oddr_bound [create_bound -name "oddr" -type soft -boundary {{0.00 0.00} {16.80 10.50}}]
